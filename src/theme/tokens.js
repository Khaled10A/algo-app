export const PALETTES = {
  dark: {
    ...
    shadowCard: "none",
    shadowPopover: "0 18px 50px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.08)",
  ...
  light: {
    ...
    shadowPopover: "0 18px 50px rgba(0, 0, 0, 0.22), 0 0 0 1px rgba(0, 0, 0, 0.06)",
...
export const MOTION = {
  ...
  base: "0.22s cubic-bezier(0.25, 0.1, 0.25, 1)",
};
